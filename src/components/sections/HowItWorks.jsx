...
//             width={70} 
//             alt="progress bar" 
//             className={`absolute top-0 left-0 ${step.no === '01' ? 'size-1/2' : ''} ${step.no === '02' ? 'w-1/2 h-full' : ''}`}/>
//             <h1 className="text-[#2b2134] text-center items-center w-fit mx-auto my-auto text-[20px] font-semibold">{step.no}</h1>
//           </div>
